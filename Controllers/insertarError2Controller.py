...
class InsertarError2Controller(QWidget):
    def __init__(self, vista_insertarError2):
        super().__init__()
        #uic.loadUi("Ventanas/insertarError2Panel.ui", self)
        self.vista = vista_insertarError2
