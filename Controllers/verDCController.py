...
class VerDCController:
    def __init__(self, mainWindow):
        ...
        # ---------------------------- ACCIONES Y EVENTOS ---------------------------------------------------------------------------------------------------------
        self.mainWindow.tableFileVDC.itemClicked.connect(self.mostrar)
    ...
    def mostrar(self, item):
        ...
        nombre = self.mainWindow.tableFileVDC.item(fila, 0)    # Extraemos el objeto celda de la columna 0 (Nombre) en esa fila
